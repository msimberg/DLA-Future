...
class Pika(CMakePackage, CudaPackage, ROCmPackage):
    ...
    version('no-locks-polling', git='https://github.com/msimberg/pika.git', branch='no-locks-mpi-cuda-counts')
    version('small-vector', git='https://github.com/msimberg/pika.git', branch='revert-small-vector')
